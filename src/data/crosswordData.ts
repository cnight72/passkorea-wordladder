...
export const CROSSWORD_EASY_1: Crossword = {
  ...
  grid: [
    [
      ...
      { char: '떡', number: 3, isBlank: false, across: 1, down: 3 },
      { char: '', isBlank: true },
      { char: '', isBlank: true },
    ],
    [
      { char: '눈', number: 4, isBlank: false, across: 2, down: 1 },
      { char: '금', number: 5, isBlank: false, across: 2, down: 2 },
      { char: '지', number: 6, isBlank: false, across: 2, down: 3 },
      { char: '', isBlank: true },
      { char: '', isBlank: true },
    ],
    [
      { char: '손', number: 7, isBlank: false, across: 3, down: 1 },
      { char: '고', number: 8, isBlank: false, across: 3, down: 2 },
      { char: '기', number: 9, isBlank: false, across: 3, down: 3 },
      { char: '', isBlank: true },
      { char: '', isBlank: true },
    ],
  ...
  clues: {
    across: [
      { number: 1, text: '흰 쌀 (3글자)', answer: '밥국떡', direction: 'across', length: 3 },
      { number: 2, text: '얼굴의 기관 (3글자)', answer: '눈고기', direction: 'across', length: 3 },
      { number: 3, text: '신체 부위 (3글자)', answer: '손금지', direction: 'across', length: 3 },
    ],
    down: [
      { number: 1, text: '세로 1번 (3글자)', answer: '밥눈손', direction: 'down', length: 3 },
      { number: 2, text: '세로 2번 (3글자)', answer: '국고금', direction: 'down', length: 3 },
      { number: 3, text: '세로 3번 (3글자)', answer: '떡기지', direction: 'down', length: 3 },
    ],
  },
};
