    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <div className="bg-gradient-to-r from-green-600 to-green-800 text-white py-12 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-green-100 mb-3">축하합니다!</p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-blue-50 rounded-lg p-4 text-center">
              <p className="text-sm text-gray-600">사용한 단어</p>
              <p className="text-3xl font-bold text-blue-600">{words.length}</p>
            </div>
            <div className="bg-purple-50 rounded-lg p-4 text-center">
              <p className="text-sm text-gray-600">평균 점수</p>
              <p className="text-3xl font-bold text-purple-600">
                {Math.round(score / words.length)}
              </p>
            </div>
          </div>

          <div className="bg-gray-50 rounded-lg p-4 mb-8">
            <p className="text-sm font-bold text-gray-800 mb-3">📚 사용한 단어</p>
